...
function render(){
	...
	var translateX = document.getElementById("translateXbutton").classList.contains("active") ? 0.01 : 0;  
	var translateY = document.getElementById("translateYbutton").classList.contains("active") ? 0.01 : 0;  
	translation = [translation[0] + translateX, translation[1] + translateY, translation[2]];  
...
document.getElementById("translateXbutton").onclick = function() {  
	this.classList.toggle("active");  
};  
  
document.getElementById("translateYbutton").onclick = function() {  
	this.classList.toggle("active");  
};  
  
document.getElementById("xbutton").onclick = function() {  
	document.getElementById("translateXbutton").classList.remove("active");  
	document.getElementById("translateYbutton").classList.remove("active");  
	axis = xAxis;  
};  
